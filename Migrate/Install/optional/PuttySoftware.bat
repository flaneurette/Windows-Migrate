...
:: Configuration
:: -------------------------------
set "product_name=Putty"
set "SOFTWARE_URL=https://the.earth.li/~sgtatham/putty/latest/w64/putty-64bit-0.83-installer.msi"
set "SOFTWARE_EXE=%TEMP%\putty-64bit-0.83-installer.msi"
